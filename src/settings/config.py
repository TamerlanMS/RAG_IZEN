...
class LLMSettings(OpenAIModel):
    ...
    chat_model: str = Field(
        default="gpt-4.1-mini", description="Название модели для чата"
    )
...
class PineconeSettings(BaseModel):
    ...
    index_name: str = Field(
        default="izen-names", description="Название индекса в Pinecone"
    )
    index_host: str = Field(
        default="https://izen-names-rkhbx77.svc.apu-57e2-42f6.pinecone.io",
